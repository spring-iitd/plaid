...
class CAN(object):
    ...
    # def send_periodic_msgs(self,control):
    #     can_bus = can.interface.Bus('vcan0', bustype='socketcan')
    #     if isinstance(control, carla.VehicleControl):
    #         # Access and print the values of steer, gear, brake, and throttle
    #         s = control.steer
    #         g = control.gear
    #         b = control.brake
    #         t = control.throttle
    #     else:
    #         print("control is not an instance of the Control class")
        
    #     tb_msg = self.send_throttle_brake(t,b)
    #     s_msg = self.send_steering(s)
    #     g_msg = self.send_gear(g)
    #     task = can_bus._send_periodic_internal([s_msg,tb_msg,g_msg], period)
    ...
    try:
        ...
        while True:
            ...
            # Access and print the values of steer, gear, brake, and throttle
                ...
                t = control.throttle
            #print(control)
                tb_msg = hud.can.send_throttle_brake(t,b)
                s_msg = hud.can.send_steering(s)
                g_msg = hud.can.send_gear(g)
                task = can_bus._send_periodic_internal([s_msg,], 0.1)
                task = can_bus._send_periodic_internal([tb_msg], 0.15)
                task = can_bus._send_periodic_internal([g_msg], 0.2)

            #hud.can.send_periodic_msgs(control)

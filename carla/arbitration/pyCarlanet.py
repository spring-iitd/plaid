...
def arbitration(benign_can_queue, dos_can_queue):
    ...
    with open('./logs_and_dbc/processed_logs.log', 'w') as output_file:
        while not benign_can_queue.empty() or not dos_can_queue.empty():
            ...
            if temp_list:
                ...
                simulation_time += can_data_size / 500000 + 0.00006
...
if __name__ == "__main__":
    ...
    read_can_logs('./logs_and_dbc/can_logs.log', benign_can_queue, 'benign')
    read_can_logs('./logs_and_dbc/dos_data_logs.log', dos_can_queue, 'dos')

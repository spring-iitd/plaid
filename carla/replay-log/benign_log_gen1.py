...
class CAN(object):
    def __init__(self):
        ...
        self.log_file = open('./only_m_data.log', 'w')
    ...
    def send_throttle_brake(self, throttle,brake):
        # To-do
        self.log_file.write(str(throttle))
        self.log_file.write('\n')
        self.log_file.write(str(brake))
        self.log_file.write('\n')
        can_bus = can.interface.Bus(channel='vcan0', interface='socketcan')
    ...
    def __del__(self):
        ...
        try:
            ...
            print("No log file opened!")
        except Exception as e:
            print(f"An error occurred while closing the file: {e}")
        try:
            self.can_dump_process.terminate()
            self.can_dump_process.wait()
            print("Stopped candump logging!")
        except Exception as e:
            print(f"An error occurred while stopping candump logging: {e}")
...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        if isinstance(control, carla.VehicleControl):
            ...
            # print("Steer val: ", control.steer)
            # print("Gear val: ", control.gear)
            # print("Throttle val: ", control.throttle)
            # print("Brake val: ", control.brake)
            # print()
            ind += 1
...
def clear_tmp():
    subprocess.run('rm -f ./new_data.log', shell=True)
...
def game_loop(args):
    ...
    try:
        ...
        if args.sync:
            ...
            settings.fixed_delta_seconds = 0.020

...
#     test_dataset_dir = 'Target_dataset_old/test/test_DoS_T_images'
#     test_label_file =  'Target_dataset_old/test/test_DoS_T_images/DoS_T_test.txt'
    
#     surr_model_path = "Trained_Models/dos_spoof_d161.pth"
#     test_model_path = "Trained_Models/dos_spoof_wisa.pth"
    
#     output_path = "DoS_adv_images_old_tst"

#     #folder and filename to save results
#     folder = '/home/ipali/scratch/code/PLAID-main/CF_Results/new'
#     filename = 'blackbox_dos.png'
...
def main():
    ...
    image_save_path = "blackbox_spoof"
    #folder and filename to save results
    folder = '/home/ipali/scratch/code/PLAID-main/CF_Results/'
    filename = 'blackbox_spoof30maxinj.png'
   ...
   # List of max_perturbations to iterate over
    ...
    for max_injection_perturbations in max_perturbations_list:
        ...
        # Call the attack procedure 
        preds, labels = Attack_procedure(model, test_model, device, test_loader, injection_type, modification_type, epsilon, max_injection_perturbations,image_save_path)
        et = time.time()
        print("End time:", et)
